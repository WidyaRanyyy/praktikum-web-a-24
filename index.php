...
<body>
    ...
    <header>
        <div class="header-top">
            <div class="logo-judul">
                <img src="foto/logo.png" alt="Dari Bontang" class="logo-kanan">
                <h1>Dari Bontang</h1>
            </div>
    ...
    <section id="produk" class="section">
        ...
        <div class="grid">
            <div class="card">
                <img src="foto/udeng.jpg" alt="Udeng Batik Kuntul Perak">
            ...
            <div class="card">
                <img src="foto/keripikbawis.jpg" alt="Keripik Bawis">
                <h3>Keripik Bawis</h3>
            ...
            <div class="card">
                <img src="foto/batik.jpg" alt="Pakaian Batik Kuntul Perak">
    ...
    <section id="makanan" class="section">
        ...
        <div class="grid">
            <div class="card">
                <img src="foto/gammibawis.jpg" alt="Gammi Bawis">
                <h3>Gammi Bawis</h3>
